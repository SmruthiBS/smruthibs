...
public class University {
 ...
 public University(String name,int no_students,long phone,String email,String city,String[] teachers,int[] employee_id, int[] salary,String[]subjects,String[] commetie,int[]classes)
	{
