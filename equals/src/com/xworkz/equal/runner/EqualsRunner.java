...
public class EqualsRunner {
	public static void main(String[] args) {
		...
		Vechile vechile2 = new Vechile("car", "tesla", " Model S", "black", 100000000, "electricity", 4, 6, "road",
				true);
		...
		WaterBottle bottel1 = new WaterBottle("cello", "black", 500, "plastic", 100, "10X20X30", true, 1, "cylinder",
				0);
		System.out.println(bottel1);
		WaterBottle bottel2 = new WaterBottle("cello", "black", 500, "plastic", 100, "10X20X30", true, 1, "cylinder",
				0);
